...
_dummy_objects = {}
_additional_imports = {}
_import_structure = {"pipeline_output": ["OmegaSpectraV2PipelineOutput"]}

if is_transformers_available() and is_flax_available():
    _import_structure["pipeline_output"].extend(["FlaxOmegaSpectraV2PipelineOutput"])
try:
    ...
    _import_structure["pipeline_omegaspectrav2"] = ["OmegaSpectraV2Pipeline"]
...
if is_transformers_available() and is_flax_available():
    ...
    _import_structure["pipeline_flax_stable_diffusion_xl"] = ["FlaxOmegaSpectraV2Pipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_omegaspectrav2 import OmegaSpectraV2Pipeline
    ...
    try:
        ...
        from .pipeline_output import FlaxOmegaSpectraV2PipelineOutput
