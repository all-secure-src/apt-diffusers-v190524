...
class StableDiffusionXLInstructPix2PixPipeline(
    ...
    # Copied from diffusers.pipelines.stable_diffusion_xl.pipeline_omegaspectrav2.StableDiffusionXLPipeline._get_add_time_ids
    ...
    # Copied from diffusers.pipelines.stable_diffusion_xl.pipeline_omegaspectrav2.StableDiffusionXLPipeline.upcast_vae
    def upcast_vae(self):
    ...
    def __call__(
        ...
        return OmegaSpectraV2PipelineOutput(images=image)
